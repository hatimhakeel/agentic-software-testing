...
- Validate test cases document has comments
  If test cases document is an excel worksheet use the Comments pane or Comments column
  Do not proceed with test case review updates if their are no cell comments or Comments column entries. Request user to add at least one comment and reupload the document to proceed.
...
2. The review updates could be present in Steps, Prerequisites, Expected Result, Test Case Name, Test Data column cells.
3. Analyze review comments and update the relevant test case element: Steps, Prerequisite, Expected Result, Test Case Name, Test Data column cells.
...
8. If comments available in Comments column; Add new "Replies" column, use the exact name.
   Add the Review Reply in the corresponding new Replies column cell.
